...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="<%=basePath%>visit_findByPage.action"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<td>选择时间：</td>
													<td>
														<INPUT class=textbox id="beginDate" style="WIDTH: 180px" name="beginDate" readonly="readonly" value="${beginDate}">
														至
														<INPUT class=textbox id="endDate" style="WIDTH: 180px" name="endDate" readonly="readonly" value="${endDate}">
													<td>
